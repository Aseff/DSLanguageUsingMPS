...
/*package*/ class Square_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.rows$KwCf;
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.columns$Kx6h;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("<no columns>");
  ...
  private static final class PROPS {
    /*package*/ static final SProperty rows$KwCf = MetaAdapterFactory.getProperty(0x2d064a06718f4b44L, 0x8bef870f5b7946beL, 0x3440514ce984307dL, 0x3440514ce984307eL, "rows");
    /*package*/ static final SProperty columns$Kx6h = MetaAdapterFactory.getProperty(0x2d064a06718f4b44L, 0x8bef870f5b7946beL, 0x3440514ce984307dL, 0x3440514ce9843080L, "columns");
  }
